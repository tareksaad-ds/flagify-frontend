  ...
  return (
    <>
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-semibold text-text-primary mt-2">Create an account</h1>
        <p className="text-text-muted text-sm mt-1">Start managing your feature flags</p>
      </div>
